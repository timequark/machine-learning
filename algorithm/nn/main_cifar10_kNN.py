...
def test(cifar10Dir):
    ...
    for k in [1, 3, 5, 10, 20, 50]:
        ...
        print('k: {}'.format(k))
        print('-------------')
        clf = KNeighborsClassifier(n_neighbors=k, algorithm='ball_tree', n_jobs=-1).fit(X_train_rows, y_train)
        ...
        validation_accuracies.append((k, clf.score(X_test_rows, y_test)))
...
if __name__ == '__main__':
    test('F:/data-warehouse/machine-learning-dataset/cifar-10-python/cifar-10-batches-py')
    logging.info('over')
